...
/**
 * NASA-7 polynomial thermodynamic database for ten combustion-product species.
 * Coefficients sourced from NASA TP-2002-211556 (McBride, Zehe, Gordon).
 * <p>
 * Supported species: H2O, CO2, H2, CO, OH, O2, N2, H, O, NO.
 */
public final class NasaSpeciesDatabase {
     ...
     * for all ten supported species.
     */
    public NasaSpeciesDatabase() {

       this.database = Map.ofEntries(

             // H2O: Water vapor
             Map.entry("H2O", new SpeciesData("H2O", 18.015,
             ...
             // CO2: Carbon dioxide
             Map.entry("CO2", new SpeciesData("CO2", 44.01,
             ...
             Map.entry("H2", new SpeciesData("H2", 2.016,
             ...
             // CO: Carbon monoxide
             Map.entry("CO", new SpeciesData("CO", 28.01,
             ...
             // OH: Hydroxyl radical
             Map.entry("OH", new SpeciesData("OH", 17.007,
             ...
             // O2: Molecular oxygen
             Map.entry("O2", new SpeciesData("O2", 32.0,
             ...
             Map.entry("N2", new SpeciesData("N2", 28.014,
             ...
             // H: Atomic hydrogen
             Map.entry("H", new SpeciesData("H", 1.008,
             ...
             // O: Atomic oxygen
             Map.entry("O", new SpeciesData("O", 16.0,
             ...
             // NO: Nitric oxide — forms from N2 + O2 at combustion temperatures (≥ 3000 K)
             Map.entry("NO", new SpeciesData("NO", 30.006,
                   new double[]{4.218476300e+00, -4.638976000e-03, 1.104102200e-05, -9.336135400e-09, 2.803577000e-12, 9.844623000e+03, 2.280846400e+00},
                   new double[]{3.260605600e+00, 1.191104300e-03, -4.291704800e-07, 6.945766900e-11, -4.033609900e-15, 9.920974600e+03, 6.369302700e+00})));
