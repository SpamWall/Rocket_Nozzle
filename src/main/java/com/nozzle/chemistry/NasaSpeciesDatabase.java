...
public final class NasaSpeciesDatabase {
    ...
    public NasaSpeciesDatabase() {
        Map<String, SpeciesData> db = new HashMap<>();

        // H2O: Water vapor
        db.put("H2O", new SpeciesData("H2O", 18.015,
        ...
        // CO2: Carbon dioxide
        db.put("CO2", new SpeciesData("CO2", 44.01,
        ...
        db.put("H2", new SpeciesData("H2", 2.016,
        ...
        // CO: Carbon monoxide
        db.put("CO", new SpeciesData("CO", 28.01,
        ...
        // OH: Hydroxyl radical
        db.put("OH", new SpeciesData("OH", 17.007,
        ...
        // O2: Molecular oxygen
        db.put("O2", new SpeciesData("O2", 32.0,
        ...
        db.put("N2", new SpeciesData("N2", 28.014,
        ...
        // H: Atomic hydrogen
        db.put("H", new SpeciesData("H", 1.008,
        ...
        // O: Atomic oxygen
        db.put("O", new SpeciesData("O", 16.0,
